...
export const USER_SERVICE_CHANGEUSERNAME_URL = USER_SERVICE_DOMAIN + "/changeUsername";
export const USER_SERVICE_CHANGEPW_URL = USER_SERVICE_DOMAIN + "/changePassword";
